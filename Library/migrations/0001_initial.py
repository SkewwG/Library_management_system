# Generated by Django 2.0.1 on 2018-01-16 05:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('borrowBook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookBorrow', to='Library.Book', verbose_name='所借书籍名字')),
            ],
        ),
        migrations.CreateModel(
            name='ReturnBook',
            fields=[
                ...
                ('returnBook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookReturn', to='Library.Book', verbose_name='所还书籍名字')),
            ],
        ),
        migrations.CreateModel(
            name='User',
